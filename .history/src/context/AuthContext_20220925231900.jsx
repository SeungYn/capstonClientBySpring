...
export function AuthProvider({ authService, authErrorEventBus, children }) {
  ...
  const logIn = useCallback(
    ...
    async (nickname, password) => {
      authService
        ...
        .then((data) => {
          setUser(data.loginId.toString());
          localStorage.setItem('userID', data.loginId.toString());
          setUserId(data.loginId.toString());
        })
  ...
  const context = useMemo(
    ...
    [user, signUp, logIn, logout, error, userId, setError]
  );
