...
export default function SecondPage({ partyService }) {
  ...
  const partyItemScrollTop = useRef(null);
  ...
  const handelerFocus = (e) => {
    console.log(ref.current.target.scrollTop);
  };
  ...
  return (
    <section className={styles.container}>
      ...
      <section className={styles.partyList1} onScroll={(e) => console.log(e)}>
        <PartyList
