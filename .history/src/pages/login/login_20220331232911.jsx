...
const Login = ({
  ...
  const onAuthenticationAtivate = (e) => {
  ...
  //인증번호가 맞는지 체크
  const onAuthenticationNumberVerification = async () => {
    const data = await onEmailVerification(email);
    data && setAuthenticationAtivation(true);
  };
