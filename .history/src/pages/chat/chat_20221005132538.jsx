  ...
  client.connect(
    ...
    (successCallback) => {
      ...
      client.send(
        '/pub/party/message',
        {
          Authorization: `Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxIiwiYXV0aCI6IlJPTEVfVVNFUiIsImV4cCI6MTY2NDk0NDQ3NH0.9LUxhT-nvew16zcfm87wnz816U3SKMAfFtBHvCCI47kI5K1MI7cSUGI6DPcE4AT51UNGSi4L0uQcxQMblCrIKQ`,
        },
        JSON.stringify(data)
      );
      console.log(client.connected);
