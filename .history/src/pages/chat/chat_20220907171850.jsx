...
const Chat = ({ chatService }) => {
  ...
  useEffect(() => {
    ...
    const chatSync = chatService.onSync('chat', (data) =>
      setChats([...chats, data])
    );
    const inSync = chatService.onSync('join', (data) => console.log(data));
    return () => disConnect();
  }, [chatService]);
  return (
