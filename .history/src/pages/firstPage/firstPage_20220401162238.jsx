...
const FirstPage = ({ kakao, kakaoService }) => {
  ...
  useEffect(() => {
    ...
    setLoading(false);
    console.log(123);
    kakaoService.getAllMap('d').then((data) => console.log(data));

    const mapContainer = mapRef.current;
    const mapOption = {
      center: new kakao.maps.LatLng(37.1935, 127.022611),
      level: 3,
    };

    const map = new kakao.maps.Map(mapContainer, mapOption);

    const markerPosition = new kakao.maps.LatLng(37.1935, 127.022611);
