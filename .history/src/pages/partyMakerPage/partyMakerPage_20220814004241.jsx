  ...
  return (
    ...
    >
      ...
      <div className={styles.partyMakerBody}>
        ...
        <div className={styles.partyMakerBody__category}>
          식당 &nbsp;
          <select
            onChange={onChange}
            className={styles.partyMakerBody__category__select}
            name='restaurant'
          >
            <option value='4'>카페테리아</option>
            <option value='5'>중국집입니다</option>
            <option value='6'>컵밥</option>
          </select>
        </div>
