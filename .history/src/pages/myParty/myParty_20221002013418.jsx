...
const MyParty = ({ partyService }) => {
  ...
  const onReport = (resId, partyId, targetId, reportType, description) => {
    ...
    partyService.reportParty(resId, partyId, targetId, reportType, description);
  };
  ...
  return (
    <section className={styles.myParty__container}>
      ...
      {reportContentSwitch && <ReportContent reportContent={reportContent} />}
      {kickAlertSwitch && (
        <KickAlert
          party={party}
