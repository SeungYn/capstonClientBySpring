  ...
  return (
    <section className={styles.myParty__container}>
      ...
      <ul className={styles.partyInfo}>
        <li className={styles.partyInfo__title}></li>
        <li className={styles.partyInfo__resTitle}></li>
        <li className={styles.partyInfo__address}></li>
        <li className={styles.partyInfo__partyMaster}></li>
        <li className={styles.partyInfo__count}></li>
      </ul>
