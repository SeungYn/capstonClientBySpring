export default class ChatService {
  ...
  async getChats(partyId, restaurantId) {
    console.log(partyId, restaurantId);
    //console.log(`/user/restaurant/${partyId}/party/${restaurantId}/chat`);
    console.log('123123123');
    const data = await this.http.fetch(
      `/user/restaurant/${partyId}/party/${restaurantId}/chat`,
      {
        method: 'GET',
        headers: this.getHeaders(),
      }
